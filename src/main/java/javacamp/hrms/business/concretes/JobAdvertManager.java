...
public class JobAdvertManager implements JobAdvertService {
	...
	@Override
	public DataResult<List<JobAdvert>> getActiveJobAdvertByEmployerList() {
		return new SuccessDataResult<List<JobAdvert>>(this.jobAdvertDao.getActiveJobAdvertByEmployerList());
	}
